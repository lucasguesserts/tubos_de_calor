...
temperatures_forced = []
temperatures_20 = [data[40][j] for j in range(3, 13)]
temperatures_30 = [data[41][j] for j in range(3, 13)]
temperatures_40= [data[42][j] for j in range(3, 13)]
temperatures_50 = [data[43][j] for j in range(3, 13)]
temperatures_60 = [data[44][j] for j in range(3, 13)]
temperature_environment = data[44][13]
...
ax.plot(positions, temperatures_30, "-cs")
ax.plot(positions, temperatures_40, "-gs")
ax.plot(positions, temperatures_50, "-ys")
ax.plot(positions, temperatures_60, "-rs")
...
figure_name = figure_dir + r"comparison_power_8_ethanol.png"
...
legend = ["20 $[W]$","30 $[W]$","40 $[W]$","50 $[W]$","60 $[W]$","Ambiente"]
