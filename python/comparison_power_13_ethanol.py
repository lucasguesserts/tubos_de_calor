...
temperatures_forced = []
temperatures_20 = [data[1][j] for j in range(3, 13)]
temperatures_40 = [data[3][j] for j in range(3, 13)]
temperatures_60= [data[4][j] for j in range(3, 13)]
temperatures_80 = [data[7][j] for j in range(3, 13)]
temperature_environment = data[1][13]
...
figure_name = figure_dir + r"comparison_power_13_ethanol.png"
